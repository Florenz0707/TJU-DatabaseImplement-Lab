...
struct config_int ConfigureNamesInt[] =
{
    ...
    {
        {"hnsw.ef_search", PGC_USERSET, RESOURCES_MEM,
            gettext_noop("Sets the size of the dynamic candidate list for search."),
            gettext_noop("Valid range is 1..1000."),
            NULL
        },
        &hnsw_ef_search,
        HNSW_DEFAULT_EF_SEARCH, HNSW_MIN_EF_SEARCH, HNSW_MAX_EF_SEARCH,
        NULL, NULL, NULL
    },

    {
        {"hnsw.max_scan_tuples", PGC_USERSET, RESOURCES_MEM,
            gettext_noop("Sets the max number of tuples to visit for iterative scans."),
            NULL,
            NULL
        },
...
struct config_real ConfigureNamesReal[] =
{
    ...
    {
        {"hnsw.scan_mem_multiplier", PGC_USERSET, RESOURCES_MEM,
            gettext_noop("Sets the multiple of work_mem to use for iterative scans."),
            NULL,
            NULL
        },
...
struct config_enum ConfigureNamesEnum[] =
{
    ...
    {
        {"hnsw.iterative_scan", PGC_USERSET, RESOURCES_MEM,
            gettext_noop("Sets the mode for iterative scans."),
            NULL,
            NULL
        },
        &hnsw_iterative_scan,
        HNSW_ITERATIVE_SCAN_OFF, hnsw_iterative_scan_options,
        NULL, NULL, NULL
    },
